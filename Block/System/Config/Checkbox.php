...
class Checkbox extends Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
       ...
       <input type="hidden" name="groups[location][fields][place_online_the_same][value]" value="0">
        <input id="cocote_location_place_online_the_same" name="groups[location][fields][place_online_the_same][value]" data-ui-id="checkbox-groups-location-fields-place-online-the-same-value" value="1" '.$checked.' class="" type="checkbox" />
        ';
        return $html;
    }
